...
@section('header-title', __('Create New Plan'))
    ...
    <form action="{{ route('admin.subscription-plan.store') }}" method="POST">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-3">
                    <x-input type="text" name="duration" label="Duration (days)" placeholder="Duration"
                        onlyNumber="true" />
                </div>

                <div class="mt-3">
                    <x-input type="text" name="sale_limit" label="Sell Limit" placeholder="Sell Limit"
                        onlyNumber="true" />
                </div>
