                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="mt-3">
                            ...
                            <select id="tags" name="tags[]" class="form-control selectTags" multiple style="width: 100%">
                                @foreach ($tags as $tag)
                                    <option value="{{ $tag->name }}" {{ in_array($tag->id, $blogTags) ? 'selected' : '' }}>{{ $tag->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-4">
                        ...
                        <label for="thumbnail" class="blogThumbnail">
                            <img src="{{ $blog->thumbnail ?? 'https://placehold.co/880x440/f1f5f9/png' }}" id="preview" alt="preview" width="100%">
                        </label>
